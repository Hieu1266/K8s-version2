...
import { getQuizPeerReviewInfoAction, getQuizSubmissionsAction } from "@/actions/getPeerReview";
...
export default function TesterQuizUsersPage({
    ...
    const [normalSubmissions, setNormalSubmissions] = useState<SubmissionListItem[]>([]);
