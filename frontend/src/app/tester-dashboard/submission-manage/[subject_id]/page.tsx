            ...
            <section className="bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 text-white py-10 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-orange-50 text-sm mt-1">
                        Môn học ID: <span className="font-mono text-amber-100">{subject_id}</span>
                    </p>
                </div>
            </section>
                            ...
                            >
                                <div>
                                    <div className="flex justify-between items-start gap-2 mb-2">
                                        <span className="text-[10px] font-bold px-2.5 py-1 rounded-md bg-orange-50 text-orange-600 border border-orange-100">
                                ...
                                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-orange-500 text-white text-xs font-bold hover:bg-orange-600 transition"
                                    >
