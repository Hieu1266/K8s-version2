...
export default function TesterSubmissionDetailPage({
    ...
    return (
        <div className="min-h-screen bg-slate-100 text-slate-800 pb-20">
            ...
            {/* Header */}
            <section className="bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 text-white py-8 px-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                                <FileText size={18} className="text-orange-600" /> Chi tiết câu hỏi ({detail.answers.length})
                            </h2>
                                ...
                                <div key={ans.detail_id || idx} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                                    <div className="flex justify-between items-start gap-4 mb-3">
                                        <div className="font-bold text-slate-800 text-sm flex items-start gap-2">
                                            <span className="bg-blue-50 text-orange-600 px-2 py-0.5 rounded-md text-xs font-bold border border-blue-100 shrink-0 mt-0.5">
                                                Câu {idx + 1}
                                            </span>
                                            <div
                                        ...
                                        <div className="flex items-center gap-1.5 shrink-0 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-xl">
                                            ...
                                            <input
                                                ...
                                                className="w-16 text-center font-bold text-sm bg-white border border-slate-300 rounded-lg py-0.5 px-1 text-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500"
                                            />
                                    ...
                                    <div className="mt-4 pt-3 border-t border-slate-100">
                                        <label className="text-xs font-bold text-slate-500 flex items-center gap-1.5 mb-1.5">
                                            <MessageSquare size={13} className="text-orange-600" /> Nhận xét của người chấm:
                                        </label>
                                        <textarea
                                            rows={2}
                                            ...
                                            className="w-full text-xs p-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-500 text-slate-700 placeholder-slate-400"
                                        />
                                    </div>
                                </div>
                            ))}
